...
//    Rightspeed=Steer;
//  }
//  // this was commented between here... 
//  Serial.print("Left:");
...
void GoThenStop()
{
 ...
 Leftmode=0;  // 0 is forward, 2 is backwards
 Rightmode=0; // 0 is forward, 2 is backwards
 
  LeftPWM=abs(Leftspeed-Leftcenter)*10/scale;                 // scale 1000-2000uS to 0-255
  LeftPWM=min(LeftPWM,200);                                   // set maximum limit 255
//
  RightPWM=abs(Rightspeed-Rightcenter)*10/scale;              // scale 1000-2000uS to 0-255
  RightPWM=min(RightPWM,200);                                 // set maximum limit 255
  
    
delay(500);
 Leftmode=2;  // 0 is forward, 2 is backwards
 Rightmode=2; // 0 is forward, 2 is backwards
...
//delay(500);
 ...
 //Leftmode=1;  // 0 is forward, 2 is backwards
 //Rightmode=1; // 0 is forward, 2 is backwards
